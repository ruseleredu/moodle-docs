---
id: alpine-moodle-configuration
title: ⚙️ Configuration
description: How to configure Moodle in the Alpine container
slug: /alpine-moodle/configuration
sidebar_position: 7
---
...
:::note
`REDIS_USER` requires Redis 6+ ACLs _and_ `REDIS_PASSWORD`. The container fails fast if you set a user without a password.
:::
