---
id: alpine-moodle-persistence
title: 💾 Persistence & Volumes
description: How to persist data in Moodle containers
slug: /alpine-moodle/persistence
sidebar_position: 6
---
...
<Tabs>
  <TabItem value="persistent" label="Persistent (default)" default>
