---
id: alpine-moodle-sqlite
title: 🗃️ SQLite Single-Container Mode
description: How to run Moodle with an embedded SQLite database
slug: /alpine-moodle/sqlite
sidebar_position: 8
---

# 🗃️ SQLite Single-Container Mode
...
For anything else, use [PostgreSQL or MariaDB](docker-compose.mdx).
