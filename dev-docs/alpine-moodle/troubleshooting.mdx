---
id: alpine-moodle-troubleshooting
title: 💡 Troubleshooting
description: Common issues and solutions for the Alpine Moodle container
slug: /alpine-moodle/troubleshooting
sidebar_position: 11
---
...
**Cause**: Recent `postgres:alpine` images (18+) expect the named volume at `/var/lib/postgresql`, not `/var/lib/postgresql/data`. Mounting the wrong path makes Postgres create an _anonymous_ volume and Moodle starts from scratch. Related: [#133](https://github.com/erseco/alpine-moodle/issues/133).
...
See [Upgrading](upgrading.mdx) for the full procedure.
